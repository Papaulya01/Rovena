...
function createWindow() {
  ...
  mainWindow.on('ready-to-show', () => {
    closeSplash()
    // Открываем сразу развёрнутым на весь экран — и для CRM на ПК/ноутбуке/большом
    // мониторе, и для панели кассира на моноблоке (это одно и то же окно,
    // роль определяет только контент внутри, см. App.jsx). Пользователь может
    // после этого свернуть/уменьшить окно вручную — maximize только стартовое состояние.
    mainWindow.maximize()
    mainWindow.show()
  })
