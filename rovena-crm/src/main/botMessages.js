...
const ru = {
  ...
  needRegistrationBeforeAction: 'Прежде чем оформить заказ или бронь, укажите, пожалуйста, имя и телефон.',
  ...
  statusUpdateDeliveryProcessing: 'Ваш заказ №{id} принят и готовится 👨‍🍳 Скоро передадим его курьеру.',
  statusUpdateDeliveryDone: 'Ваш заказ №{id} передан курьеру 🚚 Скоро будет у вас!',
...
const uzLatn = {
  ...
  needRegistrationBeforeAction: "Buyurtma yoki bron rasmiylashtirishdan oldin, iltimos, ism va telefon raqamingizni kiriting.",
  ...
  statusUpdateDeliveryProcessing: "Buyurtmangiz №{id} qabul qilindi va tayyorlanmoqda 👨‍🍳 Tez orada kuryerga topshiramiz.",
  statusUpdateDeliveryDone: "Buyurtmangiz №{id} kuryerga topshirildi 🚚 Tez orada yetkaziladi!",
...
const uzCyrl = {
  ...
  needRegistrationBeforeAction: 'Буюртма ёки брон расмийлаштиришдан олдин, илтимос, исм ва телефон рақамингизни киритинг.',
  ...
  statusUpdateDeliveryProcessing: 'Буюртмангиз №{id} қабул қилинди ва тайёрланмоқда 👨‍🍳 Тез орада курьерга топширамиз.',
  statusUpdateDeliveryDone: 'Буюртмангиз №{id} курьерга топширилди 🚚 Тез орада етказилади!',
